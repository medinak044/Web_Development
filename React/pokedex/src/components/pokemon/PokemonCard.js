...
import spinner from './spinner_spinning_line.gif'
...
-moz-user-select: none;
  ...
  -o-user-select: none;
`
// Takes <Link /> and applies custom styling (from blue underlined links to regular black link text)
...
export default class PokemonCard extends Component {
    state = {
        ...
        imageUrl: ``,
        pokemonIndex: ``,
        imageLoading: true, // Error handling
        tooManyRequests: false, // Error handling
    }
